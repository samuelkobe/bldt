			...
			<footer class="footer bg-grey-dark text-grey-light pt-8 lg:pt-0" role="contentinfo">
				...
				<div class="contained flex flex-col lg:flex-row lg:items-start justify-center lg:justify-start w-full pb-8 lg:pb-12">
					...
					<p class="flex flex-row items-center justify-center w-full lg:w-1/2 text-center h-12 lg:h-24 text-sm lg:text-base">
						&copy; <?php echo date('Y'); ?> <?php bloginfo('name'); ?>. 
						<?php _e('Powered by', 'web-ok-starter'); ?>
						<a href="https://webok.ca" target="_blank" class="hover:text-brand-dev transition-colors duration-200">&nbsp;Web Ok Solutions Inc.</a>
					</p>
